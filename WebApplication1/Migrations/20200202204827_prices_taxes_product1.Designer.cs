...
namespace WebApplication1.Migrations
{
    ...
    [Migration("20200202204827_prices_taxes_product1")]
    partial class prices_taxes_product1
    {
            ...
            modelBuilder.Entity("WebApplication1.Models.ProductProduct", b =>
                {
                    ...
                    b.Property<float>("qty_available")
                        .HasColumnType("real");

                    b.Property<float>("qty_virtual")
                        .HasColumnType("real");

                    b.Property<int?>("tax_idId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("WebApplication1.Models.ProductProduct", b =>
                {
                    ...
                    b.HasOne("WebApplication1.Models.Tax", "tax_id")
                        .WithMany()
                        .HasForeignKey("tax_idId");
                });
